...
const USER_TYPE_DESCRIPTION =
  "Al registrarse los visitantes seleccionan una de las siguientes categorias" +
...
export const validateInputsChangePassword = (
...
export const validateInputsRegister = (
