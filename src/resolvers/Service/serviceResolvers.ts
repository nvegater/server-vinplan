...
import {
  CreateServiceInputs,
  ReserveServiceInputs,
  UpdateServiceInputs,
} from "./serviceResolversInputs";
...
export class ServiceResolver {
  ...
  async allServices(
    ...
    cursor: string | null,
    @Arg("experienceName", () => String, { nullable: true })
  ...
  async salesConcentrate(
    @Arg("paypalTransaccionId", () => String, {
      nullable: true,
      description:
        "if you put null or undefined" +
        "the query will return all events registration",
    })
