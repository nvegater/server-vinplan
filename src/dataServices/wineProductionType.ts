import {WineProductionType, ProductionType} from "../entities/WineProductionType"
...
const insertProductionTypeToWinery = async (wineryId : number, productionType : ProductionType) => {
...
const deleteProductionTypeToWinery = async (wineryId : number, productionType : ProductionType) => {
