...
const insertImageInServiceGallery = async (
  serviceId: number,
  urlImage: string,
  coverPage: boolean
) => {
...
const insertDefaultPictureToEvent = async (
  eventType: EventType,
  urlImage: string
) => {
...
const updateDefaultPictureToEvent = async (
  eventType: EventType,
  urlImage: string
) => {
...
const unSelectCoverPageImage = async (serviceId: number) => {
  return await getConnection()
    ...
    .where("serviceId = :serviceId and coverPage = :coverPage", {
      serviceId: serviceId,
      coverPage: true,
    })
    .returning("*")
...
export default {
  ...
  findImageById,
  deleteImageById,
  findDefaultImageByEventType,
  insertDefaultPictureToEvent,
  updateDefaultPictureToEvent,
  deleteDefaultPictureToEvent,
};
