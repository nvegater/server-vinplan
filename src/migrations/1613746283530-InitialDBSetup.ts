...
export class InitialDBSetup1613746283530 implements MigrationInterface {
    name = 'InitialDBSetup1613746283530'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "service_reservation" ("userId" integer NOT NULL, "serviceId" integer NOT NULL, "noOfAttendees" integer, CONSTRAINT "PK_0b16ac8260a9c26430df296e142" PRIMARY KEY ("userId", "serviceId"))`);
        await queryRunner.query(`CREATE TYPE "service_eventtype_enum" AS ENUM('Comida/Cena Maridaje', 'Degustación', 'Concierto')`);
        await queryRunner.query(`CREATE TABLE "service" ("id" SERIAL NOT NULL, "title" character varying(63) NOT NULL, "description" character varying(255) NOT NULL, "eventType" "service_eventtype_enum" NOT NULL, "startDateTime" TIMESTAMP NOT NULL, "endDateTime" TIMESTAMP NOT NULL, "rRules" text array DEFAULT '{}'::text[], "wineryId" integer NOT NULL, "creatorId" integer NOT NULL, "duration" integer NOT NULL, "limitOfAttendees" integer, "noOfAttendees" integer, "pricePerPersonInDollars" double precision NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(6), "updatedAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(6), CONSTRAINT "PK_85a21558c006647cd76fdce044b" PRIMARY KEY ("id"))`);
