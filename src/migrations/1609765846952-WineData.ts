...
export class WineData1609765846952 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        queryRunner.query(`
        insert into winery (id, name, description, "foundationYear", "creatorId", "googleMapsUrl") values (1, 
        ...
        insert into winery (id, name, description, "foundationYear", "creatorId", "googleMapsUrl") values (2, 
        ...
        insert into winery (id, name, description, "foundationYear", "creatorId", "googleMapsUrl") values (3, 
