...
export class WineData1609765846952 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        queryRunner.query(`
        insert into winery (id, name, description, "foundationYear", "creatorId", "googleMapsUrl") values (100, 
                                                                                          ...
                                                                                          2010,
                                                                                          1,'https://goo.gl/maps/ciCxHaYAivfuLqaB8');
        insert into winery (id, name, description, "foundationYear", "creatorId", "googleMapsUrl") values (200, 
                                                                                  ...
                                                                                  , 2002, 1, 'https://goo.gl/maps/peEH3ZbpuFboUxUA9');

        insert into winery (id, name, description, "foundationYear", "creatorId", "googleMapsUrl") values (300, 
