...
export class UserType1623192883566 implements MigrationInterface {
    name = 'UserType1623192883566'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "user_usertype_enum" AS ENUM('WINERY OWNER', 'WINE TOURIST', 'HOTEL', 'TRANSPORTATION COMPANY', 'CONCIERGE', 'TOUR OPERATOR', 'DISTRIBUTOR', 'PRESS', 'SOMMELIER', 'TOURIST GUIDE', 'DRIVER', 'TRAVEL AGENCY', 'DMC', 'OCV', 'EVENT PLANNER')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "winery_image_gallery"."coverPage" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "user"."userType" IS NULL`);
        await queryRunner.query(`CREATE TYPE "user_usertype_enum_old" AS ENUM('Turista', 'Enoturista', 'Profesional', 'Empresarial', 'Intermediario', 'Winery_Owner')`);
