...
export class serviceImageGallery1623804369901 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "service_image_gallery" ("id" SERIAL NOT NULL, "serviceId" integer, "imageUrl" character varying, "coverPage" boolean NOT NULL DEFAULT 'false', CONSTRAINT "PK_bdd6504d4c655b71f27276e8513" PRIMARY KEY ("id"))`);
